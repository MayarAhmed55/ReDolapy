  ...
  <div class="s-wrap">
    ...
    <div class="card">
      <div class="section-head">
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#1550D3" stroke-width="1.8" aria-hidden="true">
    ...
    <div class="card">
      <div class="section-head">
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#1550D3" stroke-width="1.8" aria-hidden="true">
    ...
    <div class="card">
      <div class="section-head">
        <svg width="16" height="20" viewBox="0 0 24 24" fill="none" stroke="#1550D3" stroke-width="1.8" aria-hidden="true">
      ...
      <div class="links-grid">
        <a class="link-item" href="#" @click.prevent>
          <div class="link-left">
            <svg width="16" height="20" viewBox="0 0 24 24" fill="none" stroke="#434654" stroke-width="1.8" aria-hidden="true">
              <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/>
            </svg>
            <span class="link-text">Documentation</span>
          </div>
          <svg class="chevron" width="8" height="12" viewBox="0 0 8 14" fill="none" stroke="#434654" stroke-width="1.8" aria-hidden="true"><polyline points="1 1 7 7 1 13"/></svg>
        </a>
        ...
        <a class="link-item" href="#" @click.prevent>
          <div class="link-left">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#434654" stroke-width="1.8" aria-hidden="true">
        ...
        <button class="link-item danger-link" @click="signOut">
          <div class="link-left">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#BA1A1A" stroke-width="1.8" aria-hidden="true">
