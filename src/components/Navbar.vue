            ...
            <Transition name="dropdown">
              ...
              >
                ...
                <div class="relative w-full">
                  <div
                    class="dropdown-item-row cursor-pointer flex justify-between items-center"
                ...
                <div
                  class="logout-footer border-t border-gray-50 flex justify-end pb-2"
                >
                  <button
                    @click="
                      handleLogout();
      ...
      <Transition name="mobile-overlay">
        ...
        >
          ...
          <Transition name="mobile-drawer">
            <aside
              v-if="mobileOpen"
              class="absolute inset-y-0 w-[78%] max-w-xs bg-white flex flex-col shadow-xl"
              :class="$i18n.locale === 'ar' ? 'left-0' : 'right-0'"
              role="dialog"
              aria-modal="true"
            ...
            >
              ...
              <div
                class="flex flex-col gap-3 px-5 pb-6 pt-4 border-t border-gray-100"
              >
                ...
                <div
                  v-else
                  class="rounded-md border border-gray-100 overflow-hidden"
                >
                  <button
                  ...
                  <Transition name="accordion">
                    <div
                      ...
                      class="bg-white border-t border-gray-100 divide-y divide-gray-50"
                    >
                      <!-- Email -->
...
.toggle-circle {
  ...
  top: 1px; /* يضمن توسيط الدائرة عمودياً */
  transform: translateX(0); /* نقطة البداية الافتراضية */
  transition: transform 0.25s cubic-bezier(0.4, 0, 0.2, 1); /* أنيميشن الحركة السلسة */
}
