        ...
        <nav
            ...
            <div class="relative flex h-16 items-center justify-between">
                ...
                <div id="Nav-Buttons"
                    ...
                    <button class="signBttns" id=logIn>Login</button>
                    <button class="signBttns" id=signUp>Sign up</button>
                </div>
            </div>
